		...
		<div class="tl_hedgeCard statemark_ill_wish">				
					<div class="tl_hedgeGrid">
						...
						<div class="projectName">
							<div>`+name+`<a class="blockexplorer" href="https://seporlia.etherscan.io/address/`+tokenPairAddress+`" target="_blank" alt="SC" title="Go to Etherscan">`+truncatedTokenAdd+`</a></div>
